...
namespace ChatServerDLL
    {
        ...
        public User CreateUser(string username)
            ...
            public List<string> ForDisplayChatrooms(string currUser)
            {
                return instance.ForDisplayChatrooms(currUser);
            }
            ...
            public string getOrCreatePersonalRoom(User user1, User user2)
            {
            ...
            {
                return instance.GetUserByName(username);
            }
    }
    }
